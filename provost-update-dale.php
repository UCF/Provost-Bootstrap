...
Description: Requires WP Post Template plugin.
*/
the_post();
?>
...
<title>Provost's Update - <?php echo the_title(); ?></title>
<style type="text/css">
	<!--
...
<table class="t640" width="640">
	<tr>
		<td><img src="<?php echo THEME_IMG_URL; ?>/dale/banner.png" alt="UCF banner" class="responsiveimg" /></td>
	</tr>
	<tr>
		<td>
									...
									<table class="tcollapse100" align="right">
										...
										<tr>
											<td class="ccollapse100pb" style="padding-bottom: 10px;">
												<img src="<?php echo THEME_IMG_URL; ?>/dale/profile-circle.jpg" alt="Provost Dale Whittaker, Ph.D" align="right" />
												<img src="<?php echo THEME_IMG_URL; ?>/dale/signature.gif" alt="Provost Dale Whittaker, Ph.D" align="left" />
											</td>
										</tr>
										<tr>
