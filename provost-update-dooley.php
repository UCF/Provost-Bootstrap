<?php
/*
WP Post Template: Elizabeth Dooley
*/
the_post();
?>
									...
									<table class="tcollapse100" align="right">
										...
										<tr>
											<td class="ccollapse100pb" style="padding-bottom: 40px;">
												<span style="font-weight: bold;">Dr. Elizabeth A. Dooley, Interim Provost</span><br>
												Vice Provost, Division of Teaching and Learning<br>
										...
										<tr>
											<td class="ccollapse100">
												<table style="font-size: 13px;">
													...
													<tr>
														<td style="padding-bottom: 5px;">
															Orlando, FL 32816-0065 • <a style="color: #006699;" href="https://provost.ucf.edu">https://provost.ucf.edu</a>
														</td>
													</tr>
													<tr>
														<td style="padding-bottom: 5px;">
